		...
		try {
    		...
    		while (studentResult.next()) {
    			int tstudId = studentResult.getInt("id");
      	        ...
      	        firstName = studentResult.getString("firstName");
      	        lastName = studentResult.getString("lastName");
      	        studAge = studentResult.getString("stuAge");
      	        studClass = studentResult.getString("stuClass");
      	        studGender = studentResult.getString("stuGender");
	      					...
	      					try {
			      	    		...
			      	    		while (updateResult.next()) {
			      	    			...
			      	    			regNum = upregNum;
			      	      	        ...
			      	      	        lastName = uplastName;
			      	      	        studAge = upstuAge;
			      	      	        studClass = upstuClass;
			      	      	        studGender = upstuGender;
